      ...
      <!-- 지도 표시화면 -->
		<div class="main">
			...
			<table> 
				<tr>
					<th>제목</th>
					<td><input name="title" style="width:100%; height:50px;" value="${vo.title}"></td> 
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea rows="10" cols="10" style="resize:none;  width: 100%;" wrap="on" name="content" > ${vo.content}</textarea> </td> 
				</tr>
			</table>
			<input class="bu" type="button" value="목록으로" onclick="location.href='b_list.do'">
			<input class="bu" type="button" value="취소하기" onclick="location.href='b_view.do?idx=${vo.idx}'">
