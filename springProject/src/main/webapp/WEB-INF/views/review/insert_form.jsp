      ...
      <!-- 지도 표시화면 -->
		<div class="main">
			...
			<table>
				...
				<tr>
					<th>작성자</th>
					<td><input  name="userNick" style="width: 100%; height:50px;color:#000;" readonly value="${userList[0].userNick}"></td>
				</tr>
				<tr>
					<th>내용</th>
				...
				<tr>
					<th>평점</th>
					<td>
						<input name="star" style="width: 100%; height:50px;color:#000;">
					</td>
				</tr>
			</table>
			<input class="button" type="button" value="목록으로" onclick="location.href='list.do'">
			<input class="button" type="button" value="새글작성" onclick="send();">
			</form>
		</div>
		<!-- END MAIN -->
