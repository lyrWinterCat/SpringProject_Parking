...
<!-- INSERT CSS -->   
 <link rel="stylesheet" href="resources/assets/css/insert.css">
<!-- MAIN CSS -->
      ...
      <!-- 지도 표시화면 -->
		<div class="main">
			...
			<table> 
				<tr>
					<th>제목</th>
					<td><input name="title" value="${vo.title }" style="width:100%; height:50px;"></td> 
				</tr>
				<tr>
					<th>내용</th>
					<td><textarea rows="10" cols="10" style=" width: 100%; resize:none;" wrap="on" name="content"> </textarea> </td> 
				</tr>
				<tr>
					<th>별점</th>
					<td><input name="star" value="${vo.star }" style="width:100%; height:50px;"></td> 
				</tr> 
			</table>
			<input class="bu" type="button" value="목록으로" onclick="location.href='list.do'">
			<input class="bu" type="button" value="취소하기" onclick="location.href='view.do?idx=${vo.idx}'">
			<input class="bu" type="button" value="수정하기" onclick="send(this.form);">
			</form>
		</div>
		<!-- END MAIN -->
